...
def train_main(args):
    ...
    # 5. Triple Barrier Labeling (same as LGB for fair comparison)
    ...
    # 6. Split: 70% train, 10% val, 20% test (ensuring temporal order)
    ...
    # Increase model capacity slightly to handle features better
